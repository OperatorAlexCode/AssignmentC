...
class MedKit(override var context: Context,override var tile: Tile) : Item(context,tile) {
    override val isPlaced: Boolean get() = true
    override fun spriteRes(): Int = R.drawable.medkit
    var pickupSfx: MediaPlayer = MediaPlayer.create(context,R.raw.scoreup)
