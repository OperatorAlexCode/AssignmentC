...
class EnemyManager(var context: Context, private val maze: Maze, private val playerManager: PlayerManager) {
    var enemies: MutableList<Enemy> = mutableListOf()

    fun spawnEnemies() {
        val nonWallOrPlayerTiles =
            maze.Tiles.flatten().filter { !it.IsWall && !it.isPlayerLocation }
